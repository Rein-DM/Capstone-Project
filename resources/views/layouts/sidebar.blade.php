...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
    ...
    <div class="sidebar-brand-text mx-3"><img src="{{url('admin_assets/img/accounting.png')}}" alt=""><sup></sup></div>
  </a><br>
  ...
  <li class="nav-item">
                ...
                <span class="sidebar-icon">Announcements</span></a>
            </li>
  ...
  <li class="nav-item" >
                ...
                <span class="sidebar-icon">Chat-Users</span></a>
            </li>
  ...
  <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span class="sidebar-icon">Table Name</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Role Types</h6>
                        <a class="collapse-item" href="{{ route('preaudits') }}">Pre-Audit</a>
                        <a class="collapse-item" href="{{ route('postaudits') }}">Post-Audit</a>
                        <a class="collapse-item" href="{{ route('encoders') }}">Encoder</a>
                        <a class="collapse-item" href="{{ route('documentreps') }}">Document<br>Representative</a>
                        <a class="collapse-item" href="{{ route('releasings') }}">Releasing</a>
                        <!-- <a class="collapse-item" href="{{ route('users') }}">Chat Box</a> -->
                        <a class="collapse-item" href="{{ route('usermanagement') }}">Users</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span class="sidebar-icon">Voucher Forms</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Voucher Records:</h6>
                        <a class="collapse-item" href="{{ route('generals') }}">General Funds</a>
                        <a class="collapse-item" href="{{ route('special') }}">Special <br> Educational <br> Funds</a>
                        <a class="collapse-item" href="{{ route('trust') }}">Trust Funds</a>
                    </div>
                </div>
            </li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
                ...
                <span class="sidebar-icon">Activity Log</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Voucher Records:</h6>
                        <a class="collapse-item" href="{{ route('generals') }}">General Funds</a>
                        <a class="collapse-item" href="{{ route('special') }}">Special Educational <br> Funds</a>
                        <a class="collapse-item" href="{{ route('trust') }}">Trust Funds</a>
                    </div>
                </div>
            </li>
...
<?php /*----------------------------------------Document Representative-------------------------------------------------------*/ ?>
  ...
  <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/posts">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Show Announcements</span></a>
            </li>
            @endif
<?php /*----------------------------------------Pre Audit-------------------------------------------------------*/ ?>
