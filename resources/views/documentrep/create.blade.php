...
@section('title', 'Create Document-Representative Users')
  
@section('contents')
    <hr />
    <form action="{{ route('documentreps.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            <div class="col">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <input type="text" name="Role" class="form-control" value="Document Representative" readonly>
            </div>
        </div>
