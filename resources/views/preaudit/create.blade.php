...
@section('title', 'Create Pre-Audit Users')
  
@section('contents')
    <hr />
    <form action="{{ route('preaudits.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            <div class="col">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <input type="text" name="Role" class="form-control" value="Pre-Audit" readonly>
            </div>
        </div>
