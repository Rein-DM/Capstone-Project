...
@section('contents')
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="created_at" class="form-control" placeholder="Created At" value="{{ $encoders->created_at }}" readonly>
        </div>
        <div class="col mb-3">
            <label class="form-label">Updated At</label>
            <input type="text" name="updated_at" class="form-control" placeholder="Updated At" value="{{ $encoders->updated_at }}" readonly>
        </div>
    </div>
@endsection