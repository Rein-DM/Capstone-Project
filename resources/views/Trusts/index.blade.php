...
@if (Auth::user()->role=='Encoder')
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('trust.create') }}" class="btn btn-primary">Add Trust Funds</a>
    </div>
@endif
                ...
                <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('trust.show', $rs->id) }}" type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="View Details">Detail</a>
                                @if (Auth::user()->role=='Encoder')
                                <a href="{{ route('trust.edit', $rs->id)}}" type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit">Edit</a>
                                <form action="{{ route('trust.destroy', $rs->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')"data-toggle="tooltip" data-placement="top" title="Delete">
                                    @csrf
                                    @method('DELETE')
