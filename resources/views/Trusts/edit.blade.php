                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <input type="date" name="dateReceived" class="form-control" placeholder="dateReceived" value="{{ $trusts->dateReceived }}" title="Date Received" min="2020-01-01" 
                                        max="2030-01-01">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                        <input type="date" name="Released" class="form-control" placeholder="Released" value="{{ $trusts->Released }}" title="Date Released" min="2020-01-01" 
                                        max="2030-01-01">
                                            <div class="form-control-icon">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                        <input type="date" name="Issuance" class="form-control" placeholder="Issuance" value="{{ $trusts->Issuance }}" title="Date Of Issuance" min="2020-01-01" 
                                        max="2030-01-01">
                                            <div class="form-control-icon">
                                                <i class="bi bi-calendar-check-fill"></i>
                                            </div>
