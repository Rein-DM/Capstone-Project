...
@section('title', 'Create Special Educational Funds')
                        ...
                        <div class="form-body">
                            <div class="row">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="Date" class="form-control @error('dateReceived') is-invalid @enderror" value="{{ old('dateReceived') }}"
                                                placeholder="Enter date" id="first-name-icon" name="dateReceived" title="Date Received">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('Obligation') is-invalid @enderror" value="{{ old('Obligation') }}"
                                                placeholder="Enter Obligation Request No." id="first-name-icon" name="Obligation" title="Obligation Request No.">
                                            <div class="form-control-icon">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('Disbursement') is-invalid @enderror" value="{{ old('Disbursement') }}"
                                                placeholder="Disbursement Voucher No." id="first-name-icon" name="Disbursement" readonly>
                                            <div class="form-control-icon">
                                                <i class="bi bi-list-ol"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('Dept') is-invalid @enderror" value="{{ old('Dept') }}"
                                                placeholder="Enter Dept" id="first-name-icon" name="Dept" title="Department">
                                            <div class="form-control-icon">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('Payee') is-invalid @enderror" value="{{ old('Payee') }}"
                                                placeholder="Enter Payee" id="first-name-icon" name="Payee" title="Payee">
                                            <div class="form-control-icon">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="Date" class="form-control @error('Released') is-invalid @enderror" value="{{ old('Released') }}"
                                                placeholder="Enter Date Released" name="Released" title="Date Released">
                                            <div class="form-control-icon">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="Date" class="form-control @error('Issuance') is-invalid @enderror" value="{{ old('Issuance') }}"
                                                placeholder="Enter Date Of Issuance" name="Issuance" title="Date Of Issuance">
                                            <div class="form-control-icon">
                                                <i class="bi bi-calendar-check-fill"></i>
                                            </div>
                                            <div class="invalid-feedback">
